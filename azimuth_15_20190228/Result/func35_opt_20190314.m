function [scan_thetac]=func35_opt_20190314(scan_theta)
...
if scan_theta>14
    ...
    kout_theta_1=k1_x2_theta-k22_theta;
    kout_theta_2=-k1_x2_theta+k22_theta;
%     kout_theta_1(1:7)=kout_theta_2(1:7);
    kout_theta=kout_theta_1;
end
...
if FlagDraw==1
    ...
    fa2_plot_nochange=fa.p1*xxx.^4+fa.p2*xxx.^3+fa.p3*xxx.^2+fa.p4*xxx+fa2.p5;
...
%     legend off
%     axis([-1000,300,0,Farest])
%     if scan_theta>14
%         axis([-300,600,0,Farest])
%     end
    view(-90,90)
